...
### 6. Where does the sentiment data come from?
...
### 7. Will you support more markets beyond Polymarket and Kalshi?
...
### 10. What's the supply?
1,000,000,000 (one billion) $EDGE total. Fixed. No inflation, no minting key, no future printer. The breakdown is 80% to the fair market on pump.fun, 10% to liquidity (locked 12 months), 5% to treasury, 3% to marketing (vested 6 months), and 2% to the founding team (vested 24 months with a 6-month cliff).

### 11. What does holding $EDGE unlock?
Tiered utility on the terminal: 10,000 $EDGE unlocks whale alerts; 100,000 unlocks the proprietary divergence radar; 1,000,000 unlocks raw API access; 10,000,000 unlocks the insider channel and monthly call. We design tiers around real cost-to-serve — if a feature costs us infra or signal value, it sits behind a tier proportional to that cost.
...
### 14. Is there a presale or private round?
No. No presale, no private round, no allowlist, no team-priority allocation. Everyone — including us — buys at the same prices off the same curve at the same time. The 2% team allocation is post-launch, vested 24 months with a 6-month cliff, and on-chain verifiable.

### 15. Is liquidity locked?
Yes — 10% of supply paired with the launch curve graduates into a Raydium LP that is timelocked on-chain for 12 months from graduation. The lock is verifiable on any Solana explorer once the pool is live. We'll publish the lock transaction and timelock contract address in the same thread that announces graduation.

### 16. What's the team vesting?
2% of supply allocated to the founding team, fully vested over 24 months with a 6-month cliff. That means nothing unlocks for the founders for the first 6 months, then linear vesting over the following 18. Vesting is enforced by a Solana token-vesting contract, not by promise. Addresses and the vesting contract are published at launch.

### 17. What if pump.fun goes down?
...
### 18. Will $EDGE be listed on a CEX?
...
### 22. Why bootstrapped?
Because the moat is product, brand voice, and track record — not capital. Venture money would force us to prioritize a return profile over the user, and our user is the trader. Bootstrapped means we ship what traders want, accountable to token holders and the people actually using the terminal, not to a quarterly board update.

---

## SECURITY

### 23. Is my wallet safe using $EDGE?
...
### 24. Is there a multisig?
Yes. The treasury (5%), marketing allocation (3%), and any post-launch operational wallet are held in a Solana multisig requiring multiple signers. Single-signer custody on project funds is unacceptable and we don't do it. Multisig addresses are published at launch.

### 25. Is the smart contract audited?
...
### 26. How do I report a security vulnerability?
...
### 28. Is the $EDGE token a security?
...
### 29. What jurisdictions are restricted?
...
- Founders: cashbridgehomes@gmail.com · cashbridgehomes@gmail.com
